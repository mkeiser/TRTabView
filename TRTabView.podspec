#
#  Be sure to run `pod spec lint TRTabView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.screenshots  = "http://tristan-inc.com/trtabscreenshot.jpg"
  ...
  s.source       = { :git => "https://github.com/mkeiser/TRTabView.git", :tag => s.version.to_s }
